% File paths
morsi1 = 'C:\Users\aswat\OneDrive - Cranfield University\Aswath CFD - Master Thesis\tecplot_data\drag_test\morsi_burns1';
morsi2 = 'C:\Users\aswat\OneDrive - Cranfield University\Aswath CFD - Master Thesis\tecplot_data\drag_test\morsi_burns2';
morsi280 = 'C:\Users\aswat\OneDrive - Cranfield University\Aswath CFD - Master Thesis\tecplot_data\drag_test\morsi_burns280';

% Read data of Re 297, Grace drag model, C_td of 1, mesh size 150 microns
data1 = readmatrix(morsi1);
...
title('99% Volume Fraction Contour Map for the Morsi and Alexander drag model');
xlabel('X Axis [m]');
ylabel('Y Axis [m]');
xlim([0 2e-3]);
grid on;
