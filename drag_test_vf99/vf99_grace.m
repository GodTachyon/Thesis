% File paths
grace1 = 'C:\Users\aswat\OneDrive - Cranfield University\Aswath CFD - Master Thesis\tecplot_data\drag_test\grace_burns1';
grace2 = 'C:\Users\aswat\OneDrive - Cranfield University\Aswath CFD - Master Thesis\tecplot_data\drag_test\grace_burns2';
grace280 = 'C:\Users\aswat\OneDrive - Cranfield University\Aswath CFD - Master Thesis\tecplot_data\drag_test\grace_burns280';

% Read data of Re 297, Grace drag model, C_td of 1, mesh size 150 microns
data1 = readmatrix(grace1);
...
title('99% Volume Fraction Contour Map for the Grace drag model');
xlabel('X Axis [m]');
ylabel('Y Axis [m]');
xlim([0 2e-3]);
grid on;
legend('Pang et.al', 'Re297, C_{td} = 1.0', 'Re297, C_{td} = 2.0', 'Re297, C_{td} = 2.8', ...
